...
from src.tools.jira_tools import search_tickets, read_ticket, comment_on_ticket, update_ticket_status
...
def sprint_lead_agent():
    sprint_lead_agent = LlmAgent(
        ...
        tools=[search_tickets, read_ticket, comment_on_ticket, update_ticket_status],
